...
import { allcCategory, getByCategoryId } from "../api"
...
export const AllCategory=()=>{
    ...
    const[allcat,detallcat]=useState([])

    useEffect(()=>{
        allcCategory()
        .then(d=>{
            console.log("qwqqwqwqwqwqwqwqwqwqwqwqwqwwq");
            console.log(d);
...
debugger
    ...
    <button onClick={() =>sc(item._id)} v>{item.NameCategory}</button>
)}
    </table>}
    {/* {allD.length>0 &&  */}
    <div id='cardDiv'> 
    {allD && allD.map((item,index)=>
